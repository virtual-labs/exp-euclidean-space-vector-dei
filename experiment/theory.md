...
**<span style="font-family: 'Times New Roman'; font-size: 24px;">(ii)</span>** <span style="font-family: 'Times New Roman'; font-size: 24px;">α . (<i>x</i><sub>1</sub>, <i>x</i><sub>2</sub>, <i>x</i><sub>3</sub>, ..., <i>x<sub>n</sub></i>) = (<i>α.x</i><sub>1</sub>, <i>α.x</i><sub>2</sub>, <i>α.x</i><sub>3</sub>, ..., <i>α.x<sub>n</sub></i>); where <i>α</i> ∈ <i>R</i> and (<i>x</i><sub>1</sub>, <i>x</i><sub>2</sub>, <i>x</i><sub>3</sub>, ..., <i>x<sub>n</sub></i>) ∈ <i>R<sup>n</sup></i></span>
...
<span style="font-family: 'Times New Roman'; font-size: 24px;"><b>NOTE:</b> (i) The elements of <i>F</i> are called <b>scalars</b> and the elements of <i>V</i> are <b>vectors</b>. A vector space over <i>F</i> will be denoted by <i>V</i>.<br> 
