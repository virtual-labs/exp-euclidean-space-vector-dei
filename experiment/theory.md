...
In the same manner, <i>R</i> and <i>R</i><sup>3</sup> can be identified with the line and space respectively. Such a visualization is not possible for <i>R<sup>n</sup></i> , for <i>n</i>>3.
...
**5. n-dimensional Euclidean Space:**
 It is the system ( <i>R<sup>n</sup></i> , + , . ) together with <i>R</i>, where <i>R<sup>n</sup></i> = {(<i>x</i><sub>1</sub>, <i>x</i><sub>2</sub>, <i>x</i><sub>3</sub>, ... , <i>x<sub>n</sub></i>) | <i>x</i><sub>1</sub>, <i>x</i><sub>2</sub>, <i>x</i><sub>3</sub>, ... , <i>x<sub>n</sub></i> ∈ <i>R</i>} and operations + and . called addition and scalar multiplication respectively are defined as:
...
**(ii)** α . (<i>x</i><sub>1</sub>, <i>x</i><sub>2</sub>, <i>x</i><sub>3</sub>, ... , <i>x<sub>n</sub></i>) = (<i>α.x</i><sub>1</sub>, <i>α.x</i><sub>2</sub>, <i>α.x</i><sub>3</sub>, ... , <i>α.x<sub>n</sub></i>); where <i>α</i> ∈ <i>R</i> and (<i>x</i><sub>1</sub>, <i>x</i><sub>2</sub>, <i>x</i><sub>3</sub>, ... , <i>x<sub>n</sub></i>) ∈ <i>R<sup>n</sup></i>
