1.	On the first page of simulation, first step is to choose a point on plane. Given a pair of axes, there is a corresponding point in R<sup>2</sup>. It is provided in Step 2 on the same page.
